...
public class DBHelper extends SQLiteOpenHelper{
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            db.execSQL(CustomizedStringHelper.DB_PROCESS_CREATE);
...
//            db.execSQL("DROP TABLE IF EXISTS lengthOfTime");
    ...
    public boolean insertDefaultCustomizedSchedule(SQLiteDatabase db,String alias, String value){
        ...
        contentValues.put(CustomizedStringHelper.CUSTOMIZEDSCHEDULE_COLUMN_ALIAS, alias);
        contentValues.put(CustomizedStringHelper.CUSTOMIZEDSCHEDULE_COLUMN_VALUE, value);
        db.insert(CustomizedStringHelper.CUSTOMIZEDSCHEDULE_TABLE_NAME, null, contentValues);
        return true;
    }
